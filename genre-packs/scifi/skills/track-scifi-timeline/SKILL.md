---
name: track-scifi-timeline
description: track world and plot chronology. Use this skill when scifi-stage work needs this operation. Applies only within the scifi Genre Pack.
category: scifi
---

# /track-scifi-timeline

## Purpose

Track world and plot chronology for `scifi` projects.
