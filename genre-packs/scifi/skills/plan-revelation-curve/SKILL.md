---
name: plan-revelation-curve
description: plan information release for settings and tech. Use this skill when scifi-stage work needs this operation. Applies only within the scifi Genre Pack.
category: scifi
---

# /plan-revelation-curve

## Purpose

Plan information release for settings and tech for `scifi` projects.
