---
name: weave-scifi-plot
description: connect plot turns to speculative premises. Use this skill when scifi-stage work needs this operation. Applies only within the scifi Genre Pack.
category: scifi
---
...
Connect plot turns to speculative premises for `scifi` projects.
