---
name: check-science-consistency
description: check science and world-rule consistency. Use this skill when scifi-stage work needs this operation. Applies only within the scifi Genre Pack.
category: scifi
---

# /check-science-consistency

## Purpose

Check science and world-rule consistency for `scifi` projects.
