---
name: map-factions
description: map factions, incentives, resources, and conflicts. Use this skill when scifi-stage work needs this operation. Applies only within the scifi Genre Pack.
category: scifi
---
...
Map factions, incentives, resources, and conflicts for `scifi` projects.
