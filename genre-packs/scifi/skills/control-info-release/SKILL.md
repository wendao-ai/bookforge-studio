---
name: control-info-release
description: reduce info dumps and stage reveals. Use this skill when scifi-stage work needs this operation. Applies only within the scifi Genre Pack.
category: scifi
---
...
Reduce info dumps and stage reveals for `scifi` projects.
