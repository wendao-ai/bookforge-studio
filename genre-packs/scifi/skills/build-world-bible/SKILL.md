...
description: create or update the world bible. Use this skill when scifi-stage work needs this operation. Applies only within the scifi Genre Pack.
category: scifi
---
...
Create or update the world bible for `scifi` projects.
