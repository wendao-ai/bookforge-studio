...
description: 'Builds and maintains the world bible. Responsibilities: Apply the `scifi` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the scifi Genre Pack needs specialist work done.'
role: builds and maintains the world bible
model: sonnet
genre: scifi
domain: scifi
...
- builds and maintains the world bible.
