---
name: scifi-reader-simulator
description: 'Simulates hard-scifi, setting, and general readers. Responsibilities: Apply the `scifi` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the scifi Genre Pack needs specialist work done.'
role: simulates hard-scifi, setting, and general readers
model: sonnet
genre: scifi
domain: scifi
...
# Scifi Reader Simulator

## Responsibilities

- simulates hard-scifi, setting, and general readers.
