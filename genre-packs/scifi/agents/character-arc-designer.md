...
description: 'Keeps character arcs tied to speculative stakes. Responsibilities: Apply the `scifi` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the scifi Genre Pack needs specialist work done.'
role: keeps character arcs tied to speculative stakes
model: sonnet
genre: scifi
domain: scifi
...
- keeps character arcs tied to speculative stakes.
