...
description: generate answer keys with explanations. Use this skill when textbook-stage work needs this operation. Applies only within the textbook Genre Pack.
category: textbook
---
...
Generate answer keys with explanations for `textbook` projects.
