---
name: align-bloom-levels
description: balance Bloom taxonomy levels. Use this skill when textbook-stage work needs this operation. Applies only within the textbook Genre Pack.
category: textbook
---
...
Balance bloom taxonomy levels for `textbook` projects.
