...
description: control concept density and sequencing. Use this skill when textbook-stage work needs this operation. Applies only within the textbook Genre Pack.
category: textbook
---
...
Control concept density and sequencing for `textbook` projects.
