---
name: build-knowledge-dag
description: build or update the concept dependency graph. Use this skill when textbook-stage work needs this operation. Applies only within the textbook Genre Pack.
category: textbook
---
...
Build or update the concept dependency graph for `textbook` projects.
