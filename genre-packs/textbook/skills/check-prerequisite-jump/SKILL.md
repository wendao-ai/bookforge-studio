---
name: check-prerequisite-jump
description: detect missing prerequisite concepts. Use this skill when textbook-stage work needs this operation. Applies only within the textbook Genre Pack.
category: textbook
---

# /check-prerequisite-jump

## Purpose

Detect missing prerequisite concepts for `textbook` projects.
