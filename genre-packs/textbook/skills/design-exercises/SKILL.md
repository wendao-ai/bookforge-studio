...
description: design exercises aligned to objectives. Use this skill when textbook-stage work needs this operation. Applies only within the textbook Genre Pack.
category: textbook
---
...
Design exercises aligned to objectives for `textbook` projects.
