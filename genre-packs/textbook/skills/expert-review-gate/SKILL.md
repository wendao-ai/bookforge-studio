...
description: prepare artifacts for expert approval. Use this skill when textbook-stage work needs this operation. Applies only within the textbook Genre Pack.
category: textbook
---
...
Prepare artifacts for expert approval for `textbook` projects.
