...
description: 'Curates examples for transfer and clarity. Responsibilities: Apply the `textbook` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the textbook Genre Pack needs specialist work done.'
role: curates examples for transfer and clarity
model: sonnet
genre: textbook
domain: textbook
...
- curates examples for transfer and clarity.
