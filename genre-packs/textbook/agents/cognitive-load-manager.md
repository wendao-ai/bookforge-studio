...
description: 'Balances new concepts per section. Responsibilities: Apply the `textbook` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the textbook Genre Pack needs specialist work done.'
role: balances new concepts per section
model: sonnet
genre: textbook
domain: textbook
...
- balances new concepts per section.
