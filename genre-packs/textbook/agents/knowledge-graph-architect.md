...
description: 'Builds the knowledge DAG. Responsibilities: Apply the `textbook` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the textbook Genre Pack needs specialist work done.'
role: builds the knowledge DAG
model: sonnet
genre: textbook
domain: textbook
