...
description: 'Checks logic consistency. Responsibilities: Apply the `nonfiction-general` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the nonfiction-general Genre Pack needs specialist work done.'
role: checks logic consistency
model: sonnet
