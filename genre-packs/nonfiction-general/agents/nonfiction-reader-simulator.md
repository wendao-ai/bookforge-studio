---
name: nonfiction-reader-simulator
description: 'Simulates target nonfiction readers. Responsibilities: Apply the `nonfiction-general` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the nonfiction-general Genre Pack needs specialist work done.'
role: simulates target nonfiction readers
model: sonnet
...
# Nonfiction Reader Simulator

## Responsibilities

- simulates target nonfiction readers.
