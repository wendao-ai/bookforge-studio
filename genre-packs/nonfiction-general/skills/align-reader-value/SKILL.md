---
name: align-reader-value
description: align claims with reader value. Use this skill when nonfiction-general-stage work needs this operation. Applies only within the nonfiction-general Genre Pack.
...
Align claims with reader value for `nonfiction-general` projects.
