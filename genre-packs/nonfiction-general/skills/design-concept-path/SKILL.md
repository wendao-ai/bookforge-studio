---
name: design-concept-path
description: design concept introduction path. Use this skill when nonfiction-general-stage work needs this operation. Applies only within the nonfiction-general Genre Pack.
...
Design concept introduction path for `nonfiction-general` projects.
