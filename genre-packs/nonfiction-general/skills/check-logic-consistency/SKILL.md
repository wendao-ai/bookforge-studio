---
name: check-logic-consistency
description: check logic consistency. Use this skill when nonfiction-general-stage work needs this operation. Applies only within the nonfiction-general Genre Pack.
...
Check logic consistency for `nonfiction-general` projects.
