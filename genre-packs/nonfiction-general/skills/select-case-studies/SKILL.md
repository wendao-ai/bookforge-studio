---
name: select-case-studies
description: select examples and cases. Use this skill when nonfiction-general-stage work needs this operation. Applies only within the nonfiction-general Genre Pack.
...
Select examples and cases for `nonfiction-general` projects.
