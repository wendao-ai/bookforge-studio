---
name: build-argument-chain
description: build the argument chain. Use this skill when nonfiction-general-stage work needs this operation. Applies only within the nonfiction-general Genre Pack.
...
Build the argument chain for `nonfiction-general` projects.
