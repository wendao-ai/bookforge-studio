---
name: audit-evidence-gaps
description: find evidence gaps. Use this skill when nonfiction-general-stage work needs this operation. Applies only within the nonfiction-general Genre Pack.
...
Find evidence gaps for `nonfiction-general` projects.
