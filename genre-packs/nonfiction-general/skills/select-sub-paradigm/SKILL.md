---
name: select-sub-paradigm
description: select nonfiction sub-paradigm. Use this skill when nonfiction-general-stage work needs this operation. Applies only within the nonfiction-general Genre Pack.
...
Select nonfiction sub-paradigm for `nonfiction-general` projects.
