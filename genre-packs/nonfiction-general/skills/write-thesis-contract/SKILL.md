---
name: write-thesis-contract
description: write the thesis contract. Use this skill when nonfiction-general-stage work needs this operation. Applies only within the nonfiction-general Genre Pack.
category: nonfiction-general
---

# /write-thesis-contract

## Purpose

Write the thesis contract for `nonfiction-general` projects.
