---
name: map-counterarguments
description: map objections and replies. Use this skill when nonfiction-general-stage work needs this operation. Applies only within the nonfiction-general Genre Pack.
...
Map objections and replies for `nonfiction-general` projects.
