...
description: 'Maintains citation format and traceability. Responsibilities: Apply the `history` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the history Genre Pack needs specialist work done.'
role: maintains citation format and traceability
model: sonnet
genre: history
domain: history
...
- maintains citation format and traceability.
