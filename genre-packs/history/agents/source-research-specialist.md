---
name: source-research-specialist
description: 'Collects and summarizes sources. Responsibilities: Apply the `history` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the history Genre Pack needs specialist work done.'
role: collects and summarizes sources
model: sonnet
genre: history
domain: history
...
- collects and summarizes sources.
