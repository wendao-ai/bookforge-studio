...
description: 'Labels source credibility and bias. Responsibilities: Apply the `history` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the history Genre Pack needs specialist work done.'
role: labels source credibility and bias
model: sonnet
genre: history
domain: history
...
- labels source credibility and bias.
