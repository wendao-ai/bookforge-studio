---
name: validate-chronology
description: check chronology and date precision. Use this skill when history-stage work needs this operation. Applies only within the history Genre Pack.
category: history
---
...
Check chronology and date precision for `history` projects.
