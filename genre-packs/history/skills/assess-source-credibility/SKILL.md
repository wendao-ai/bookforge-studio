...
description: assess credibility and bias. Use this skill when history-stage work needs this operation. Applies only within the history Genre Pack.
category: history
---
...
Assess credibility and bias for `history` projects.
