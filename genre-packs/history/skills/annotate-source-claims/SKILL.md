---
name: annotate-source-claims
description: attach claims to source basis. Use this skill when history-stage work needs this operation. Applies only within the history Genre Pack.
category: history
---

# /annotate-source-claims

## Purpose

Attach claims to source basis for `history` projects.
