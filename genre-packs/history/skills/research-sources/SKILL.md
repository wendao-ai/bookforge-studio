...
description: collect sources for a claim or chapter. Use this skill when history-stage work needs this operation. Applies only within the history Genre Pack.
category: history
---
...
Collect sources for a claim or chapter for `history` projects.
