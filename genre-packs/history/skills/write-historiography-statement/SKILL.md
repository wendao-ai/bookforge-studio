---
name: write-historiography-statement
description: define viewpoint and interpretive stance. Use this skill when history-stage work needs this operation. Applies only within the history Genre Pack.
category: history
---

# /write-historiography-statement

## Purpose

Define viewpoint and interpretive stance for `history` projects.
