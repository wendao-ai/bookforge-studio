---
name: compare-conflicting-sources
description: compare disputed evidence. Use this skill when history-stage work needs this operation. Applies only within the history Genre Pack.
category: history
---
...
Compare disputed evidence for `history` projects.
