...
description: format and trace citations. Use this skill when history-stage work needs this operation. Applies only within the history Genre Pack.
category: history
---
...
Format and trace citations for `history` projects.
