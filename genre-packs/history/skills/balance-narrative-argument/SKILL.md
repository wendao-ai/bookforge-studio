---
name: balance-narrative-argument
description: balance narrative scene and argument. Use this skill when history-stage work needs this operation. Applies only within the history Genre Pack.
category: history
---

# /balance-narrative-argument

## Purpose

Balance narrative scene and argument for `history` projects.
