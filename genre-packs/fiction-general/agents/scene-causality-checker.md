---
name: scene-causality-checker
description: 'Checks scene-to-scene causality. Responsibilities: Apply the `fiction-general` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the fiction-general Genre Pack needs specialist work done.'
role: checks scene-to-scene causality
model: sonnet
...
- checks scene-to-scene causality.
