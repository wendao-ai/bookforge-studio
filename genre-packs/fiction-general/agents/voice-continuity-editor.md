---
name: voice-continuity-editor
description: 'Checks narrative voice continuity. Responsibilities: Apply the `fiction-general` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the fiction-general Genre Pack needs specialist work done.'
role: checks narrative voice continuity
model: sonnet
...
- checks narrative voice continuity.
