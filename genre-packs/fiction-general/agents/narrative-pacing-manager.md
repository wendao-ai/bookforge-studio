---
name: narrative-pacing-manager
description: 'Manages pacing and rhythm. Responsibilities: Apply the `fiction-general` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the fiction-general Genre Pack needs specialist work done.'
role: manages pacing and rhythm
model: sonnet
