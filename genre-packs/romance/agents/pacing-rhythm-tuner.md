---
name: pacing-rhythm-tuner
description: 'Tunes sweet, bitter, and plot rhythm. Responsibilities: Apply the `romance` Genre Pack rules to the current stage; Keep outputs traceable to project constitution, registry, and genre memory. Use this agent when the romance Genre Pack needs specialist work done.'
role: tunes sweet, bitter, and plot rhythm
model: sonnet
genre: romance
domain: romance
...
- tunes sweet, bitter, and plot rhythm.
