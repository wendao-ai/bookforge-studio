---
name: calibrate-intimacy-level
description: set intimacy and heat level boundaries. Use this skill when romance-stage work needs this operation. Applies only within the romance Genre Pack.
category: romance
---

# /calibrate-intimacy-level

## Purpose

Set intimacy and heat level boundaries for `romance` projects.
