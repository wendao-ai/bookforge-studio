---
name: curate-tropes
description: select tropes and avoid stale execution. Use this skill when romance-stage work needs this operation. Applies only within the romance Genre Pack.
category: romance
---
...
Select tropes and avoid stale execution for `romance` projects.
