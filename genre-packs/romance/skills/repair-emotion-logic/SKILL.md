---
name: repair-emotion-logic
description: repair unmotivated emotional turns. Use this skill when romance-stage work needs this operation. Applies only within the romance Genre Pack.
category: romance
---

# /repair-emotion-logic

## Purpose

Repair unmotivated emotional turns for `romance` projects.
