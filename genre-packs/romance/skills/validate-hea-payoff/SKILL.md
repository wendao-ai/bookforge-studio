---
name: validate-hea-payoff
description: check HEA/HFN satisfaction. Use this skill when romance-stage work needs this operation. Applies only within the romance Genre Pack.
category: romance
---
...
Check hea/hfn satisfaction for `romance` projects.
