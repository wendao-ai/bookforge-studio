---
name: switch-genre
description: 切换 Genre Pack，并评估回溯影响——触发场景：genre-detection 阶段需要执行该操作时使用。
...
4. Apply the workflow for `genre-detection` without changing unrelated project state.
