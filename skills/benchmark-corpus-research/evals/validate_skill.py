#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""/benchmark-corpus-research 结构验证器（由 studio-architect build_eval_set.py 生成）。
...
TRIGGER_WORDS = ["/benchmark-corpus-research", "对标书调研与", "风格学习", "在宪法前抓取", "并解构品类内"]
...
def main():
    ...
    print(f"\n=== /benchmark-corpus-research 结构验证 ===")
