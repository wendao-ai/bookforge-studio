---
name: harvest-writing-pattern
description: 沉淀写作模式——触发场景：sedimentation 阶段需要执行该操作时使用。
category: sedimentation
---

# /harvest-writing-pattern

## Purpose

Save reusable patterns from successful project work.
