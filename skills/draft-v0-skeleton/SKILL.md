---
name: draft-v0-skeleton
description: 起草 V0 骨架——触发场景：草稿 阶段需要执行该操作时使用。
category: drafting
---
...
4. Apply the workflow for `drafting` without changing unrelated project state.
