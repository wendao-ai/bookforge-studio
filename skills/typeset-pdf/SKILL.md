---
name: typeset-pdf
description: 导出 PDF——触发场景：排版 阶段需要执行该操作时使用。
category: typeset
---
...
4. Apply the workflow for `typeset` without changing unrelated project state.
