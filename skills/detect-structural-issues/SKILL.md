---
name: detect-structural-issues
description: 检测结构问题——触发场景：extended-outline 阶段需要执行该操作时使用。
category: extended-outline
---
...
4. Apply the workflow for `extended-outline` without changing unrelated project state.
